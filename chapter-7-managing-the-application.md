...
In addition, the **Alarm Summary** tab will be available.
...
| **Location Scope**             | Location scope is applied to search pages where location, Equipment, Zone interfaces etc. are used.                                                                               |
