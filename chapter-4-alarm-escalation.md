...
4. Click **Add** to create the new **Notification Group**. Click the Close icon  ![](<.gitbook/assets/icon_3 (6).png>) to abort the operation.
...
4. Hover over details section and click the edit![](<.gitbook/assets/Screenshot 2024-06-07 132020 (2).png>) icon.
...
5. A message box to confirm deletion appears. Click **Delete** to confirm deletion of the **Alarm Notification Group,** or to close the message box without deleting, click ![](<.gitbook/assets/Screenshot_10 (2).png>)icon.
