...
2. Select **IBMS** Zone. There are two ways to specify an IBMS Zone.
   ...
   2. Click the **Search** ![](.gitbook/assets/Screenshot_17.png) icon and start typing in the **Search Zones** input box and it would filter the **Zones** matching the typed in text.
...
2. Click the **Add**![](.gitbook/assets/Screenshot_12.png) icon. Add Monitoring Group window will appear.
...
2. Click the **Add** ![](.gitbook/assets/Screenshot_12.png) icon. **Add a Control Group** window will open.
