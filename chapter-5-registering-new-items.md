...
## <mark style="color:purple;background-color:blue;">Register New Equipment</mark>
...
2. Select **IBMS** Zone. There are two ways to specify an IBMS Zone.
   ...
   2. Click the **Search** <img src=".gitbook/assets/Screenshot_17.png" alt="" data-size="line"> icon and start typing in the **Search Zones** input box and it would filter the **Zones** matching the typed in text.
...
### <mark style="color:purple;">Equipment Details Page</mark>

After registering an Equipment, you need to configure/edit the other details related to Equipment on Equipment page.

#### <mark style="color:purple;">Details Tab</mark>

To make changes to Asset Details;

1. Go to the Equipment detail page.
2. Mouse hover over the **Details** section and click **Edit** icon <img src=".gitbook/assets/Screenshot 2024-06-07 132020 (1) (1) (1).png" alt="" data-size="line">.
...
{% hint style="success" %}
_Tip –_ [_Point Templates_](chapter-3-configuration-of-prerequisites.md#configure-point-templates) _configured in IBMS, will be the points for equipment, registered using the respective Equipment Template and those points will be listed here._
{% endhint %}
...
3. You can configure the following attributes of a **Point** using the **Point Details** dialog box under **General** tab;
   ...
   8. Click **Update** to confirm the changes. Click the **Close** icon <img src=".gitbook/assets/Screenshot_10 (3).png" alt="" data-size="line"> to discard changes and close dialog.
...
#### <mark style="color:purple;">Links Tab</mark>
...
#### <mark style="color:purple;">Alarms Tab</mark>
...
#### <mark style="color:purple;">Trend Tab</mark>
...
## <mark style="color:purple;background-color:blue;">Register New Systems</mark>
...
3. Select **Location**. There are two ways to specify the **Location**.
   1. Click in the input box which will display a list of locations to select from, or click the **Search** icon <img src="data:image/png;base64," alt="" data-size="original"> and start typing in the **Search Locations** input box and it would filter the **Locations** matching the typed in text.
   2. Click on the **Pinboard** icon <img src=".gitbook/assets/Screenshot_16.png" alt="" data-size="line"> to select from a list of **Locations** previously pinned to the pinboard.
...
### <mark style="color:purple;">Configure Points for System</mark>
...
### <mark style="color:purple;">Alarms Tab of System</mark>
...
2. Click the **Add** icon <img src=".gitbook/assets/Screenshot_12.png" alt="" data-size="line"> . Add Monitoring Group window will appear.
3. Type a **Monitoring Group ID**.
4. Select the required **Aggregate Operator**.
5. Click **Add**.
6. To edit an added monitoring group, click the **Edit** icon <img src="data:image/png;base64," alt="" data-size="line"> .
7. To delete an already configured monitoring group, click the respective **Delete icon** ![](data:image/png;base64,).
8. To add **Points** to the respective **Monitoring Group**, click the **Assign Points** link.
   1. In the **Point** box, select required **Point** from the drop-down list. Alternatively, click the **Search** icon ![](data:image/png;base64,) and select a Point from the **Search Points** page.
...
### <mark style="color:purple;">Configure Controlling Groups for the System</mark>
...
2. Click the **Add**  icon <img src=".gitbook/assets/Screenshot_12.png" alt="" data-size="line">. **Add a Control Group** window will appear.
3. Type a **Control Group ID**.
4. Click **Add**.
5. To edit an added **Control Group**, click the respective **Edit** icon <img src="data:image/png;base64," alt="" data-size="line">.
6. To delete an already configured **Control Group**, click the respective **Delete** <img src="data:image/png;base64," alt="" data-size="line"> icon.
7. To add **Points** to the respective **Controlling Group**, click the **Assign Points** link.
   1. In the **Point** box, select required **Point** from the drop-down list. Alternatively, click the **Search** icon <img src="data:image/png;base64," alt="" data-size="line"> and select a Point from the **Search Points** page.
...
## <mark style="color:purple;background-color:blue;">Register New Dashboard</mark>
...
3. Select **Location**. There are three ways to specify a location.
   ...
   2. Click on the **Pinboard** icon  <img src=".gitbook/assets/Screenshot_16.png" alt="" data-size="line">to select from a list of locations previously pinned to the pinboard.
   3. Click on the **Search** icon  <img src="data:image/png;base64," alt="" data-size="line"> to bring up the location search popup window. Select a location from the location search page.
...
6. Go to **Details** tab,
   1. Mouse hover over the **Details** section and click the **Edit** icon <img src=".gitbook/assets/Screenshot 2024-06-07 132020 (1) (1) (1).png" alt="" data-size="line"> .
