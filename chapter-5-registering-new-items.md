...
2. Select **IBMS** Zone. There are two ways to specify an IBMS Zone.
   ...
   2. Click the **Search** ![](.gitbook/assets/Screenshot\_17.png) icon and start typing in the **Search Zones** input box and it would filter the **Zones** matching the typed in text.
3. Select **Asset**. There are three ways to specify an **Asset**.
   ...
   2. Click the **pinboard** icon![](.gitbook/assets/Screenshot\_16.png) to select from a list of Assets previously pinned to the pinboard.
...
2. Mouse hover over the **Details** section and click **Edit** icon![](<.gitbook/assets/Screenshot 2024-06-07 132020 (1).png>).
...
3. You can configure the following attributes of a **Point** using the **Point Details** dialog box under **General** tab;
   ...
   8. Click **Update** to confirm the changes. Click ![](<.gitbook/assets/Screenshot\_10 (3).png>)icon to discard changes and close dialog.
...
3. Select **Location**. There are two ways to specify the **Location**.
   1. Click in the input box which will display a list of locations to select from, or click the Search  ![](data:image/png;base64,)icon and start typing in the **Search Locations** input box and it would filter the **Locations** matching the typed in text.
   2. Click on the pinboard icon ![](.gitbook/assets/Screenshot\_16.png) to select from a list of **Locations** previously pinned to the pinboard.
...
2. Click the **Add**![](.gitbook/assets/Screenshot\_12.png) icon. Add Monitoring Group window will appear.
...
2. Click the **Add** ![](.gitbook/assets/Screenshot\_12.png) icon. **Add a Control Group** window will open.
...
6. Go to **Details** tab,
   1. Mouse hover over the **Details** section and click the **Edit** ![](<.gitbook/assets/Screenshot 2024-06-07 132020 (1).png>)icon.
...
2. Click the **Add**![](.gitbook/assets/Screenshot\_12.png) icon to open the page to add configured points.
