...
\
_**Note:** To view Weblet details on Alarm Viewer, click on a bar of the chart (e.g. Acknowledged) and click the Alarm Stage link on the Quick Info window. Alarm Viewer will open with relevant tab (e.g. Acknowledged Alarms tab)._
...
![](.gitbook/assets/Screenshot\_37.png) - When the alarm severity is deselected

![](.gitbook/assets/Screenshot\_38.png)- When the alarm severity is selected
